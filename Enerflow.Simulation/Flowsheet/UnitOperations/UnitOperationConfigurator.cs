...
public class UnitOperationConfigurator : IUnitOperationConfigurator
{
    private readonly ILogger<UnitOperationConfigurator> _logger;

    public UnitOperationConfigurator(ILogger<UnitOperationConfigurator> logger)
    {
        _logger = logger;
    }
