...
{
    private static readonly List<CompoundInfo> _compounds =
    [
        new CompoundInfo("Methane", "CH4", "74-82-8", "Alkane", "Simplest alkane, main component of natural gas"),
        new CompoundInfo("Ethane", "C2H6", "74-84-0", "Alkane", "Second simplest alkane"),
        new CompoundInfo("Propane", "C3H8", "74-98-6", "Alkane", "Used as fuel and refrigerant"),
        new CompoundInfo("N-butane", "C4H10", "106-97-8", "Alkane", "Used in gas oline ble nding"),
        new CompoundInfo("N-pentane", "C5H12", "109-66-0", "Alkane", "Used as solvent"),
        new CompoundInfo("N-hexane", "C6H14", "110-54-3", "Alkane", "Industrial solvent"),
        new CompoundInfo("N-heptane", "C7H16", "142  -82-5", "Alkane", "Reference fuel for octane rating"),
        new CompoundInfo("N-octane", "C8H 18", "111-65-9", "Alkane", "Component of gasoline"),
        new CompoundInfo("Benzene", "C6H6", "71-43-2", "Aromatic", "Basic aromatic com pound"),
        new CompoundInfo("Toluene", "C7H8", "108-88-3", "Aromatic", "Common aromatic solvent"),
    ...
    private static readonly Dictionary<PropertyPackageType, string> _propertyPackageDescriptions = new()
    {
        { PropertyPackageType.PengRobinson, "Widely used cubic EOS for hydrocarbons and gases. Good for VLE up to moderate pressures." },
        { PropertyPackageType.SoaveRedlichKwong, "Cubic EOS, good for non-polar components at low to moderate pressures." },
        { PropertyPackageType.NRTL, "Activity coefficient model for highly non-ideal liquid mixtures. Excellent for polar systems." },
        { PropertyPackageType.UNIQUAC, "Activity coefficient model based on molecular structure. Good for polar/non-polar mixtures." },
        { PropertyPackageType.RaoultsLaw, "Ideal solution model. Only for nearly ideal mixtures at low pressures." },
    };
    ...
    {
        return Enum.GetValues<PropertyPackageType>()
