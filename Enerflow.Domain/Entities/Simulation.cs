...
public class Simulation
{
   ...
   public ICollection<MaterialStream> MaterialStreams { get; set; } = [];
   public ICollection<EnergyStream> EnergyStreams { get; set; } = [];
   public ICollection<UnitOperationObject> UnitOperations { get; set; } = [];
