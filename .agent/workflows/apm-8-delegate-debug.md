...
# APM 0.6.0-token-efficient - Debug Delegation Guide
...
2. Open new Ad-Hoc agent chat session & initialize it with .agent/workflows/Ad_Hoc_Agent_Initiation_Prompt.md
